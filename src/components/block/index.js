...
import { number, boolean } from "../control-panel/knobs";

const ATTRIBUTES = {
	blockBorderAnimationSpeed: number("blockBorderAnimationSpeed", 0),
	alwaysHideBlockBorder: boolean("alwaysHideBlockBorder", true),
	toolbarFadeAnimationSpeed: number("toolbarFadeAnimationSpeed", 300),
	toolbarTopOffset: number("toolbarTopOffset", -40)
};
